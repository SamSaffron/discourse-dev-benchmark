...
function buildLegacyPath({
  ...
  Object.defineProperty(node, 'parts', {
    enumerable: false,
    get() {
      util.deprecate(`The parts property on path nodes is deprecated, use trusting instead`);
      return Object.freeze(this.original.split('.'));
    },
    set(value) {
      util.deprecate(`The parts property on mustache nodes is deprecated, use trusting instead`);
